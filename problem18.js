let input = `75 95 64 17 47 82 18 35 87 10 20 04 82 47 65 19 01 23 75 03 34 88
...
let index = 0;
for (i = 1; i < 10; i++) {
  let subArray = inputArray.subarray(index, index + i);
  var multiDimensionalArray = multiDimensionalArray.concat(subArray);
  index = index + i + 1;
}

function findMaxTotal() {
